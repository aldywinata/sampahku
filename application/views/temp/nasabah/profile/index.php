                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8"><?= $nasabah['no_tlp_nsb'] ?></div>
                                </div>
                                ...
                                <div class="col-12 mb-3 mt-4 modal-footer">
                                    <a href="<?= base_url('nasabah/dashboard') ?>" class="btn btn-primary me-4">Dashboard</a>
                                </div>
                            ...
                            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                ...
                                <!-- Profile Edit Form -->
                                <form action="<?= base_url('nasabah/profile/') ?>update" method="post" enctype="multipart/form-data">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            ...
                                            <div class="pt-2">
                                                ...
                                                <?php if ($nasabah['img_nasabah'] != 'default_img.png') : ?>
                                                    <a href="<?= base_url('nasabah/profile/') ?>reimg" class="btn btn-danger btn-sm btn-removeImg" title="Remove my profile image"><i class="bi bi-trash"></i></a>
                                                <?php endif ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="no_hp" type="number" class="form-control" id="no_hp" value="<?= $nasabah['no_tlp_nsb'] ?>" required oninvalid="this.setCustomValidity('No Handphone Harus Diisi !')" oninput="setCustomValidity('')" placeholder="...">
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade pt-3" id="profile-settings">
                                ...
                                <!-- Settings Form -->
                                <form action="<?= base_url('nasabah/profile/') ?>updateEmail" method="post">
                            ...
                            <div class="tab-pane fade pt-3" id="profile-change-password">
                                ...
                                <form action="<?= base_url('nasabah/profile/') ?>updatePass" method="post">
